...
def generate(rnn, emb, decoder, eos, start="", maxlen=200):
    ...
    Embedding(num_embeddings, embedding_dim, padding_idx=None, max_norm=None, norm_type=2.0, scale_grad_by_freq=False, sparse=False, _weight=None, device=None, dtype=None)
    embedding = emb
